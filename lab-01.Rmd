...
_character, numeric, numeric, character, character, character_
```{r Q2_part1}
...
**Not available, there is some data that is unavailable/missing**
...
**na.rm removes the not available data before computing results**
...
**There are more small values however there are a few very large values causinging a large mean**
...
_England = 350362, Northern Ireland = 311046, Scotland = 127986, Wales = 103368_
```{r Q8}
